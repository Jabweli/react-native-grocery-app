      ...
      >
        {cart && cart.length > 0 ? (
              ...
              <View className="flex-1 pt-1">
                <View className='flex-row justify-between'>
                  <View>
                    ...
                    <Text className="text-gray-400 text-sm">{cartItem.category}</Text>
                  </View>
          ...
          <View className="flex-grow flex-1 items-center justify-center">
            ...
            <Text className="font-bold text-xl mt-3 text-[#243F2F]">Your Cart is Empty</Text>
            <TouchableOpacity className='flex-row gap-2 items-center justify-center bg-green-600 px-8 py-3 rounded-full mt-5' onPress={() => router.push("/(tabs)/home")}>
      ...
      {cart && cart.length > 0 && (
        <View style={styles.priceContainer}>
          <View style={styles.priceFlexWrapper}>
            ...
            <TouchableOpacity className="bg-green-600 flex-row items-center justify-center px-5 py-4 rounded-full flex-1 ml-10">
